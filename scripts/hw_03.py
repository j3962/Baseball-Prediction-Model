...
# creating a dummy class for overriding the transform method
...
# function for getting data from the mariadb database
...
def main():
    ...
    # creating an object of the dummy class and overriding the transform method
